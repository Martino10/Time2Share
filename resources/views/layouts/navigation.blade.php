<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <!-- To User's Loaned Products -->
                        <x-dropdown-link href="{{ route('myloans', ['id' => Auth::user()->id]) }}">
                            <div>Your Loaned Items</div>
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard', ['id' => Auth::user()->id]) }}" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
