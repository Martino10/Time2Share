<div id="return_popup" class="popup">
    <div class="popup-content">
        ...
        <p class="popuptext">Are you sure you want to return this item: {{$product->name}} to {{$product->username}}?<br>The owner will be notified to accept the item once it's returned. </p>
